    ...
    export default {
        ...
        methods: {
            ...
            browse() {
                ...
                $perAdminApp.getApi().populateNodesForBrowser(currentPath, 'inputlink')
                    .then( () => {
                        this.isOpen = true
                    }).catch( (err) => {
                        $perAdminApp.getApi().populateNodesForBrowser('/content', 'inputlink')
                    })
            },
